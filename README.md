...
**Smart Dermatology** is a deep learning–based system that uses Convolutional Neural Networks (CNNs) to classify skin cancer from dermatoscopic images. The project leverages image processing techniques and a dataset from the International Skin Imaging Collaboration (ISIC) to distinguish between malignant and benign lesions. Its goal is to support early melanoma detection and reduce diagnostic delays by providing an automated, accurate, and scalable classification tool.
## Abstract
